...
from .ggraphql import ns_graphql
from .schemaVaccineDosisDependents import ns_schemaVaccineDosisDependents
from .planVaccineDependent import ns_planVaccineDependent
from .imageByDosisDependent import ns_imageByDosisDependent
...
#api_extension.add_namespace(ns_graphql)
api_extension.add_namespace(ns_planVaccineDependent)
api_extension.add_namespace(ns_imageByDosisDependent)
api_extension.add_namespace(ns_schemaVaccineDosisDependents)
